...
Escena::Escena()
{
   ...
   //primero true perspectiva false ortogonal
   //segundo desde donde miras
   //tercero ratio entre el ancho y el alto
   //cuarto donde miras
   //quinto apertura del campo
...
void Escena::visualizarGL( )
{
   ...
   if(apl->modo_visu == ModosVisu::lineas){
      ...
      cout << "Error en el modo de visualización" << endl;
   }      
   //
   // ...................
